...
const seedCourseStats = {
  ...
  averageRating:
    Math.round(
      (courses.reduce((sum, c) => sum + c.rating * c.reviews, 0) /
        courses.reduce((sum, c) => sum + c.reviews, 0)) *
        10,
    ) / 10,
}
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    course: 'Amazon Virtual Assistant & FBA',
    courseSlug: 'amazon-virtual-assistant',
    city: 'Jhang',
  ...
  },
  {
    ...
    courseSlug: 'freelancing-mastery',
    city: 'Faisalabad',
  ...
  },
  {
    ...
    course: 'Shopify & Dropshipping',
    courseSlug: 'shopify-dropshipping',
    city: 'Chiniot',
  ...
  },
  {
    ...
    course: 'Office Automation & AI Productivity',
    courseSlug: 'office-automation',
    city: 'Faisalabad',
  ...
  },
  {
    ...
    course: 'Python Programming & Data',
  ...
  },
  {
    ...
    course: 'Canva Mastery for Business',
    courseSlug: 'canva-mastery',
    city: 'Faisalabad',

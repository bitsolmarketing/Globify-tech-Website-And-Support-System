 ...
 * Server->Client props boundary (`faqFormSchema` was previously passed
 ...
 */
export function FaqForm(props: Omit<React.ComponentProps<typeof SimpleForm<FaqFormValues>>, 'schema'>) {
  return <SimpleForm schema={faqFormSchema} {...props} />
}
